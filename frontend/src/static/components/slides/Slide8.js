    ...
    <SlideContainer>
      ...
      <Box sx={{ p: 4 }}>
        ...
        <Typography variant="body1" sx={{ color: '#374151', mb: 3 }}>
          Let's review some practical examples to better understand how to apply the DTS Provisions in Section J:
        </Typography>
        ...
        <Grid container spacing={3} sx={{ mb: 3 }}>
          ...
          <Grid item xs={12} md={6}>
            <QACard>
              <Question color="blue">
                <Typography variant="h6" sx={{ fontWeight: 600, color: '#1f2937', display: 'flex', alignItems: 'flex-start' }}>
              ...
              <Answer>
                <Typography variant="body2" sx={{ color: '#4b5563', mb: 2 }}>
                  According to Part J3, what DTS Provisions apply to ceiling fans in a sole occupancy unit of a Class 2 building or a Class 4 part of a building?
                </Typography>
                <Box sx={{ backgroundColor: '#eff6ff', p: 2, borderRadius: '8px' }}>
                  <Typography variant="body2" sx={{ color: '#1e40af' }}>
                    <Box component="span" sx={{ fontWeight: 500 }}>J3D4:</Box> Ceiling fans must be installed in accordance with Table J3D4 in specified climate zones and states. They must be permanently installed and have a speed controller.
                  </Typography>
                </Box>
              </Answer>
            </QACard>
          ...
          <Grid item xs={12} md={6}>
            <QACard>
              ...
              <Answer>
                <Typography variant="body2" sx={{ color: '#4b5563', mb: 2 }}>
                  According to Part J4, what is the minimum Total R-Value required for a roof or ceiling in the following climate zones?
                </Typography>
                <Box sx={{ backgroundColor: '#ecfdf5', p: 2, borderRadius: '8px' }}>
                  <Typography variant="body2" sx={{ color: '#065f46', mb: 1 }}>
                    <Box component="span" sx={{ fontWeight: 500 }}>J4D4 roof and ceiling construction:</Box>
                  </Typography>
                  <List dense>
                    <ListItem sx={{ px: 0 }}>
                      <ClimateZone>Zone 3</ClimateZone>
                      <Highlight sx={{ ml: 1 }}>R3.7</Highlight>
                      <Typography variant="body2" sx={{ color: '#4b5563', ml: 1 }}>(downward heat flow)</Typography>
                    </ListItem>
                    <ListItem sx={{ px: 0 }}>
                    ...
                    <ListItem sx={{ px: 0 }}>
                      ...
                      <Typography variant="body2" sx={{ color: '#4b5563', ml: 1 }}>(upward heat flow)</Typography>
                    </ListItem>
                  </List>
                </Box>
              </Answer>
        ...
        <Grid container spacing={3} sx={{ mb: 3 }}>
          ...
          <Grid item xs={12} md={6}>
            <QACard>
              ...
              <Answer>
                <Typography variant="body2" sx={{ color: '#4b5563', mb: 2 }}>
                  According to Part J5, when must an exhaust fan have a sealing device like a self-closing damper?
                </Typography>
                <Box sx={{ backgroundColor: '#eff6ff', p: 2, borderRadius: '8px' }}>
                  <Typography variant="body2" sx={{ color: '#1e40af' }}>
                    <Box component="span" sx={{ fontWeight: 500 }}>J5D6 Exhaust fans:</Box> A sealing device is required when the exhaust fan services a conditioned space or habitable room in climate zones 4, 5, 6, 7 or 8.
                  </Typography>
          ...
          <Grid item xs={12} md={6}>
            <QACard>
              ...
              <Answer>
                <Typography variant="body2" sx={{ color: '#4b5563', mb: 2 }}>
                  According to Part J6, a mechanical ventilation system must have a time switch if the airflow rate is more than 1000 litres per second. When does this requirement not apply?
                </Typography>
                <Box sx={{ backgroundColor: '#ecfdf5', p: 2, borderRadius: '8px' }}>
                  <Typography variant="body2" sx={{ color: '#065f46', mb: 1 }}>
                    <Box component="span" sx={{ fontWeight: 500 }}>J6D4(4) Time switches:</Box> A time switch is not required for a mechanical ventilation system that:
                  </Typography>
                  <List dense>
                    <ListItem sx={{ px: 0 }}>
        ...
        {/* Question 5 */}
        <QACard sx={{ mt: 3 }}>
          <Question sx={{ background: 'linear-gradient(90deg, rgba(44, 125, 160, 0.15), rgba(42, 157, 143, 0.15))', borderLeft: '4px solid #3a86a3' }}>
            <Typography variant="h6" sx={{ fontWeight: 600, color: '#1f2937', display: 'flex', alignItems: 'flex-start' }}>
          ...
          <Answer>
            <Typography variant="body2" sx={{ color: '#4b5563', mb: 2 }}>
              According to Part J7, what controls can be used for exterior artificial lighting attached to or directed at the façade of a building?
            </Typography>
            <Box sx={{ background: 'linear-gradient(135deg, rgba(44, 125, 160, 0.1), rgba(42, 157, 143, 0.1))', p: 2, borderRadius: '8px' }}>
              <Typography variant="body2" sx={{ color: '#1e40af', mb: 1 }}>
                <Box component="span" sx={{ fontWeight: 500 }}>J7D6 Exterior artificial lighting:</Box> Exterior artificial lighting attached to or directed at the façade of a building must be controlled by:
              </Typography>
              <Grid container spacing={2} sx={{ mt: 1 }}>
                <Grid item xs={12} sm={6}>
                  <ControlOption>
                    <WbSunnyIcon sx={{ color: '#f97316', mt: 0.5, mr: 1 }} />
                    <Typography variant="body2" sx={{ color: '#4b5563' }}>A daylight sensor</Typography>
                  </ControlOption>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <ControlOption>
                    <AccessTimeIcon sx={{ color: '#2563eb', mt: 0.5, mr: 1 }} />
                    <Typography variant="body2" sx={{ color: '#4b5563' }}>A time switch with variable programming capabilities</Typography>
                  </ControlOption>
                </Grid>
              </Grid>
