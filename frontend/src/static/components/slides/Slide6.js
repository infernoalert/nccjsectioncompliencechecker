...
const RatingBar = styled(Box)(({ theme }) => ({
  ...
  width: '100%',
  background:
    'linear-gradient(90deg, #ff4e50 0%, #fcb69f 25%, #ffeaa7 50%, #a1c4fd 75%, #2a9d8f 100%)',
  borderRadius: '4px',
  zIndex: 0,
}));
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Typography variant="body1" sx={{ color: '#4b5563', mb: 3 }}>
                One way of meeting the heating and cooling load Performance Requirement J1P2 for an
                SOU/apartment is to do a house energy rating, which assesses the thermal performance
              ...
              <RatingContainer>
                ...
                <Typography variant="body2" sx={{ color: '#4b5563', mb: 2 }}>
                  The NatHERS rating system runs from 0 to 10 stars, with 10 stars being the most
                  energy efficient.
                </Typography>
            ...
            <ClimateZoneCard>
              ...
              <Typography variant="body2" sx={{ color: '#4b5563' }}>
                Buildings/apartments in some climate zones must meet individual cooling and heating
                load limits specific to each climate zone. This applies in mixed climate zones where
                both heating and cooling are required at different times of the year.
              </Typography>
            </ClimateZoneCard>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              <Typography variant="body1" sx={{ color: '#4b5563', mb: 2 }}>
                For a complex with 4 SOUs, one could have a 6 star rating as long as the total
                ratings for the other 3 add up to at least 22 stars.
              </Typography>
            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                  <CheckCircleIcon sx={{ color: '#059669', mt: 0.5, mr: 1 }} />
                  <Typography variant="body2" sx={{ color: '#4b5563' }}>
                    Once a star rating is completed and plans stamped, design changes require new
                    rating
                  </Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                  <CheckCircleIcon sx={{ color: '#059669', mt: 0.5, mr: 1 }} />
                  <Typography variant="body2" sx={{ color: '#4b5563' }}>
                    NatHERS rating alone doesn't satisfy J1P2 and J1P3 - must also comply with other
                    DTS provisions
                  </Typography>
                </Box>
                <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                  <CheckCircleIcon sx={{ color: '#059669', mt: 0.5, mr: 1 }} />
                  <Typography variant="body2" sx={{ color: '#4b5563' }}>
                    Working with a NatHERS assessor early in design process can identify
